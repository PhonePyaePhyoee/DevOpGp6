...
public class countryQuery {
    ...
    public void displayTopNPopulatedCountriesInContinent(List<Country> countries, String continent, int N)  {
        if (countries == null || countries.isEmpty()) {
            System.out.println("No Countries found");
        }
    ...
    // Method to retrieve the top N populated countries in a specific region, including capital names
    ...
    public void displayTopNPopulatedCountriesInRegion(List<Country> countries, String region, int N)  {
        if (countries == null || countries.isEmpty()) {
            System.out.println("No Countries found");
        }
