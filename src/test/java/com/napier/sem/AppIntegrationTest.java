...
public class AppIntegrationTest {
    ...
    void testGetWorldPopulationData() throws SQLException {
        ...
        assertEquals(7_000_000_000L, populations.get(0).getTotalPopulation()); // Adjust based on your expected total
    }
    ...
    void testGetLanguagePopulationData() throws SQLException {
        ...
        assertEquals("English", languagePopulations.get(0).getLanguage()); // Adjust based on your expected data
